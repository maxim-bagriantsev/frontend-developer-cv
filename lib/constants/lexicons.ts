export const translations = {
    en: {
        translation: {
            ...
            'stack': '(React, Next, TS, Redux Toolkit | rtk query)',
            ...
            'rosneftDescription': 'Project Manager. Development of technical specifications. Scientific and technical support for the implementation of new technologies. I am the author of scientific and technical articles',
            'accounts': 'Accounts',
            'projects': 'Projects',
            'education': 'Education',
            'skills': 'Skills',
    ...
    ru: {
        translation: {
            ...
            'experience': 'Опыт',
            'mechanica': 'July 2020 - по настоящее время',
            ...
            'rosneftDescription': 'Руководитель проекта. Разработка технического задания. Научно-техническое сопровождение работ по внедрению новых технологий. Являюсь автором научно-технических статей',
            'accounts': 'Аккаунты',
            'projects': 'Проекты',
            ...
            // education SimbirSoft
            'year': 'август 2020 - декабрь 2020 гг. (Курсы)',
            'institution': 'СимбирСофт',
            'institution_description': ' - IT-компания',
            'faculty': 'Направление:',
            'faculty__description': ' Frontend-практикум (TypeScript, React)',
