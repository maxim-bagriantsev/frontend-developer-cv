export const translations = {
  ...
  ru: {
    translation: {
      ...
      'label': 'Лейбел',
      'description': 'Трудолюбивый и увлеченный разработчик веб-сайтов. Педантичность, целеустремленность и целеустремленность в каждом проекте - мои сильные стороны. Я принимал участие как в частных, так и в коммерческих проектах. Ниже вы можете увидеть несколько из них. Я с нетерпением жду возможности стать частью вашей команды 😉'
    }
  }
};
